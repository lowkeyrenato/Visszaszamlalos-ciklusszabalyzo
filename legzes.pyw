...
# --- ÚJ: Megjegyzés a parancssori ablak elrejtéséhez ---
# HOGYAN FUTTASD A FEKETE PARANCSSORI ABLAK (CMD) NÉLKÜL:
# Egyszerűen nevezd át ezt a fájlt 'legzes.py'-ról 'legzes.pyw'-ra.
# A Windows a '.pyw' kiterjesztésű fájlokat a 'pythonw.exe'-vel futtatja,
# ami nem nyit meg konzolablakot.
...
class BreathingApp:
    ...
    def __init__(self, master: ctk.CTk):
        ...
        window_width = 450
        window_height = 480  # MÓDOSÍTOTT: Magasság növelése a checkbox miatt
        ...
        self.time_left = 0
        self.topmost_var = tk.BooleanVar(value=False) # ÚJ: Változó a "mindig felül" állapothoz
    ...
    # --- ÚJ: Metódus a "mindig felül" állapot váltásához ---
    def toggle_topmost(self):
        """Az ablak 'mindig felül' állapotát állítja a checkbox alapján."""
    ...
    def start_exercise(self):
        ...
        self.topmost_checkbox.configure(state="disabled") # MÓDOSÍTOTT: Checkbox letiltása futás közben
    ...
    def stop_exercise(self, interrupted=True):
        ...
        self.topmost_checkbox.configure(state="normal") # MÓDOSÍTOTT: Checkbox engedélyezése
